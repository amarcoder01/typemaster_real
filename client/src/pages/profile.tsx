        ...
        <Dialog open={selectedCertificate !== null} onOpenChange={(open) => !open && setSelectedCertificate(null)}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {selectedCertificate && (
              <div className="mt-4">
                {(() => {
                  // Normalize certificate type for comparison
                  const rawCertType = selectedCertificate.certificateType || selectedCertificate.certificate_type || '';
                  const certType = rawCertType.toLowerCase().trim();
                  ...
                  />
                    ...
                    return (
                      <div className="text-center py-8">
                        <p className="text-muted-foreground">Certificate preview not available for type: {selectedCertificate.certificateType || 'unknown'}</p>
                      </div>
                    );
                  }
                })()}
